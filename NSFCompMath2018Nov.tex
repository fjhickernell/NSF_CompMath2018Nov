...
The de facto choice of many authors is to choose $\calc$ to be a ball of fixed radius, $\cb_{\rho} := \{f \in \calf : \norm[\calf]{f} \le \rho \}$, which resembles a scoop of ice cream, \smallerscoop.  Then one may define $\ALG$ satisfying \eqref{AlgErr} as follows:
