...
\begin{itemize}
    \item Algorithms optimized for non-convex cones are adaptive, whereas algorithms optimized for balls will not be.  Thus, easier problems take less computational effort than harder ones.  This helps us meeet Goal \ref{GoalThree}.
